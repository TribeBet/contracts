...
module mint_nft::create_nft {
    ...
    fun init_module(source_account: &signer) {
        let collection_name = string::utf8(b"Tribe Bet NFT Profiles");
        let description = string::utf8(b"Social Betting Platform on Aptos");
        let collection_uri = string::utf8(b"https://shikhar.xyz/wp-content/uploads/2023/12/logo-betting.png");
        let token_name = string::utf8(b"Tribe Bet NFT Profile");
        let token_uri = string::utf8(b"https://shikhar.xyz/wp-content/uploads/2023/12/logo-betting.png");
